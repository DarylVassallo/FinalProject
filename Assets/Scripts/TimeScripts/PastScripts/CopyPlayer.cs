...
public class CopyPlayer : MonoBehaviour
{
    ...
    public void StartPastAttempt(int attemptIndex, int attemptPeriodStart, int attemptPeriodEnd)
    {
        ...
        else
        {
            ...
            else if(record.rewindTrigger == false)
            {
                ...
                //If The Past Player Is In Reverse, The Velocity And Angular Velocity Of The Current Interactable Object Is Set To The Last Value Of Their Respective Lists
                if(isInReverse == true)
                {
    ...
    IEnumerator Replay()
    {
        ...
        foreach (GameObject intObject in interactableObjects)
        {
            ...
            {
                //Checks If The Object Is Currently Being Grabbed By The Player
                if (intObject.GetComponent<Grabbable>().isBeingGrabbed == false)
                {
                    ...
                    if (record.rightGrab[iteration] == true)
                    {
                        ...
                        if (grabObjectRight.grabbedObject == intObject && iteration < (attemptEnd - 5))
                        {
                            ...
                            //The Object's Position And Rotation Is Set To That Of The Right Hand
                            ...
                            //The Object's Velocity And Angular Velocity Is Set To 0, And It's Gravity Is Disabled
                    ...
                    else if (record.rightGrab[iteration] == false && rightGrabWait == 0)
                    {
                        //rightGrabWait Is Set To 0 
                        rightGrabWait = 1;
                        rbObject.useGravity = true;
                        rbObject.isKinematic = false;

                        //Checks If The Current Iteration Of The Right Hand Is Not Grabbing And If The Right Hand Is Grabbing An Object
                    }
                    ...
                    if (record.leftGrab[iteration] == true)
                    {
                        ...
                        if (grabObjectLeft.grabbedObject == intObject && iteration < (attemptEnd - 5))
                        {
                            ...
                            //The Object's Position And Rotation Is Set To That Of The Left Hand
                    ...
                    else if (record.leftGrab[iteration] == false && leftGrabWait == 0)
                    {
                        //leftGrabWait Is Set To 0 
                        leftGrabWait = 1;
                        rbObject.useGravity = true;
                        rbObject.isKinematic = false;

                        //Checks If The Current Iteration Of The Left Hand Is Not Grabbing And If The Left Hand Is Grabbing An Object
                    }
            ...
            if (isInReverse == true)
            {
                ...
                //The Object's Velocity And Angular Velocity Are Set To 0, And Its Gravity Is Disabled 
                rbObject.velocity = new Vector3(0, 0, 0);
                rbObject.angularVelocity = new Vector3(0, 0, 0);
                //rbObject.useGravity = false;
            }
